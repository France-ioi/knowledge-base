---
title: "Algorea operations essentials — hub"
...
|------|---------------|--------|
| Repository layout next to this knowledge base | [Algorea — linked repositories](./algorea-linked-repositories.md) | Workspace map; not a substitute for each repo’s README. |
| Frontend app source, UI↔API expectations | [Algorea frontend](./algorea-frontend.md) | **Deploy pipelines and build scripts** for the SPA live in **[AlgoreaFrontend](https://github.com/France-ioi/AlgoreaFrontend)**—not summarized here. |
...
| Moving legacy material into `docs/` | [Legacy migration playbook](./migration.md) | Maintainer steps; same provenance rules as other curated pages. |
