...
|---|--------------|-----------------|
| **Location** | **`docs/*.md`** outside **`archive/`**, discoverable via the site nav | **`docs/archive/`** tree — entry **[docs/archive/README.md](./archive/README.md)** |
