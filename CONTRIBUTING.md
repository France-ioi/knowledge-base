...
- **Operations essentials** when they belong in this corpus’s governed docs—not a second home for full operational depth already owned elsewhere. For the **Algorea** MVP-scoped hub and topic index, see **[Operations essentials](docs/algorea-ops.md)** (under [Algorea](docs/algorea.md)).
